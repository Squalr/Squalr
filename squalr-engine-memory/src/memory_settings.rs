...
impl MemorySettings {
    ...
    pub fn get_memory_type_private(
        &self
    ) -> bool {
    ...
    pub fn get_required_copy_on_write(
        &self
    ) -> bool {
