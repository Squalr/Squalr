...
impl AppProvisionerConfig {
    ...
    pub const FILENAME: &'static str = "Olorin.zip";
    const GITHUB_API_LATEST_RELEASE: &'static str = "https://api.github.com/repos/zcanann/Olorin-Rust/releases/latest";
