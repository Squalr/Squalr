...
- Add remaining focused tests for splitting tail spans, selection stability after split, resize warnings, pointer-to-struct sizing, and struct-layout-backed module fields. Repeated `u8[]` split, overlap rejection, and delete-to-filler merge now have engine tests.
