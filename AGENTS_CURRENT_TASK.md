...
11. In progress: move Symbol Layout authoring behavior out of the GUI view.
   ...
   - Remaining whole-catalog `set-catalog` use is in Symbol Resolver editor; that should move to resolver-specific upsert/delete commands and a shared resolver mutation service.
