...
- Shared path-utility consolidation at 2026-02-18 06:12:29Z: moved cross-platform absolute path detection into `squalr-engine-api::utils::file_system::FileSystemUtils::is_cross_platform_absolute_path` and updated project-item add/reorder executors to use the shared API helper (removed duplicate local implementations).
