...
- Create tasks for pointer scanning. Base this loosely on regular scans (as far as GUI layout and styling goes), adapted to the requirements of pointer scanning.
