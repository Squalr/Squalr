...
- The PE populate action still emits concrete fields for now. The remaining PE expression gap is conditional layout selection, chiefly PE32 versus PE32+ optional-header shape from the optional header magic.
