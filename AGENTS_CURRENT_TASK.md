...
- Needs human verification in GUI: hover inline plugin priority buttons and confirm their tooltips use the Squalr tooltip style, clear when moving between buttons, row height does not overlap, and the compact/centered buttons have scrollbar clearance.
