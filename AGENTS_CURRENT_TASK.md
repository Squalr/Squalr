...
- `rust-toolchain.toml` now pins the workspace to `nightly-2026-02-07` so the repository override matches the nightly version installed by CI jobs and Android target installation lands on the same toolchain cargo actually uses.
