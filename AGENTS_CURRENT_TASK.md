...
- Project Explorer pointer-offset editing now uses a takeover repeater with add/delete rows and persists through the address-target edit path instead of in-place CSV editing. This needs human verification in the running UI.
