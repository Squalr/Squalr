...
- Project Explorer Details pointer-offset preview is a readonly string DataValueBox showing CSV-style offsets. Its edit icon opens a Details/Struct Viewer takeover repeater with add/delete rows, then persists through the address-target edit path. This needs human verification in the running UI.
