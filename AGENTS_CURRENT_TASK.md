...
- Needs human verification in GUI: hover inline plugin priority buttons and confirm their tooltips use the Squalr tooltip style, clear when moving between buttons, and the row buttons are compact/centered.
