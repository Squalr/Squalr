...
- Latest revalidation on 2026-02-22 again passed with same baseline command set; `cargo check -p squalr --locked` still reports existing GUI unused-variable/unreachable-pattern warnings, with no new failures.
