...
- Need human verification: project explorer preview strings for address/pointer items show bracketed array values (for example `[1]` and `[1, 2]`) while scalar previews remain unbracketed.
