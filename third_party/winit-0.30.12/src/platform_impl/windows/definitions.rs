...
use windows_sys::Win32::System::Com::{IAdviseSink, IDataObject, IEnumFORMATETC, IEnumSTATDATA, FORMATETC, STGMEDIUM};
...
pub struct IDataObjectVtbl {
    ...
    pub GetData: unsafe extern "system" fn(This: *mut IDataObject, pformatetcIn: *const FORMATETC, pmedium: *mut STGMEDIUM) -> HRESULT,
    pub GetDataHere: unsafe extern "system" fn(This: *mut IDataObject, pformatetc: *const FORMATETC, pmedium: *mut STGMEDIUM) -> HRESULT,
    QueryGetData: unsafe extern "system" fn(This: *mut IDataObject, pformatetc: *const FORMATETC) -> HRESULT,
    pub GetCanonicalFormatEtc: unsafe extern "system" fn(This: *mut IDataObject, pformatetcIn: *const FORMATETC, pformatetcOut: *mut FORMATETC) -> HRESULT,
    pub SetData: unsafe extern "system" fn(This: *mut IDataObject, pformatetc: *const FORMATETC, pformatetcOut: *const FORMATETC, fRelease: BOOL) -> HRESULT,
    pub EnumFormatEtc: unsafe extern "system" fn(This: *mut IDataObject, dwDirection: u32, ppenumFormatEtc: *mut *mut IEnumFORMATETC) -> HRESULT,
    ...
    pub EnumDAdvise: unsafe extern "system" fn(This: *mut IDataObject, ppenumAdvise: *const *const IEnumSTATDATA) -> HRESULT,
}
...
pub struct IDropTargetVtbl {
    pub parent: IUnknownVtbl,
    pub DragEnter:
        unsafe extern "system" fn(This: *mut IDropTarget, pDataObj: *const IDataObject, grfKeyState: u32, pt: *const POINTL, pdwEffect: *mut u32) -> HRESULT,
    pub DragOver: unsafe extern "system" fn(This: *mut IDropTarget, grfKeyState: u32, pt: *const POINTL, pdwEffect: *mut u32) -> HRESULT,
