...
pub trait WindowExtWindows {
    ...
    /// ```
    #[cfg(feature = "rwh_06")]
    unsafe fn window_handle_any_thread(&self) -> Result<rwh_06::WindowHandle<'_>, rwh_06::HandleError>;
}
...
pub trait WindowAttributesExtWindows {
    ...
    #[cfg_attr(windows_platform, doc = "[`CreateMenu`]: windows_sys::Win32::UI::WindowsAndMessaging::CreateMenu")]
    ...
    /// This sets `ICON_BIG`. A good ceiling here is 256x256.
    fn with_taskbar_icon(
        self,
        taskbar_icon: Option<Icon>,
    ) -> Self;

    /// This sets `WS_EX_NOREDIRECTIONBITMAP`.
    fn with_no_redirection_bitmap(
        self,
        flag: bool,
    ) -> Self;
    ...
    fn with_drag_and_drop(
        self,
        flag: bool,
    ) -> Self;

    /// Whether show or hide the window icon in the taskbar.
    fn with_skip_taskbar(
        self,
        skip: bool,
    ) -> Self;

    /// Customize the window class name.
    fn with_class_name<S: Into<String>>(
        self,
        class_name: S,
    ) -> Self;
    ...
    ///
    /// Requires Windows 11 build 22523+.
    fn with_system_backdrop(
        self,
        backdrop_type: BackdropType,
    ) -> Self;

    /// This sets or removes `WS_CLIPCHILDREN` style.
    fn with_clip_children(
        self,
        flag: bool,
    ) -> Self;
    ...
    ///
    /// Supported starting with Windows 11 Build 22000.
    fn with_title_background_color(
        self,
        color: Option<Color>,
    ) -> Self;
    ...
    ///
    /// Supported starting with Windows 11 Build 22000.
    fn with_corner_preference(
        self,
        corners: CornerPreference,
    ) -> Self;
}
