...
pub trait WindowAttributesExtMacOS {
    ...
    fn with_title_hidden(
        self,
        title_hidden: bool,
    ) -> Self;
    /// Hides the window titlebar.
    fn with_titlebar_hidden(
        self,
    ...
    fn with_option_as_alt(
        self,
        option_as_alt: OptionAsAlt,
    ) -> Self;
    /// See [`WindowExtMacOS::set_borderless_game`] for details on what this means if set.
    fn with_borderless_game(
        self,
        borderless_game: bool,
    ) -> Self;
}
...
pub trait EventLoopBuilderExtMacOS {
    ...
    fn with_activate_ignoring_other_apps(
        &mut self,
        ignore: bool,
    ) -> &mut Self;
}
