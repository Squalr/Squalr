...
impl WindowAttributes {
    ...
    #[inline]
    pub fn with_inner_size<S: Into<Size>>(
        mut self,
        size: S,
    ) -> Self {
    ...
    #[inline]
    pub fn with_min_inner_size<S: Into<Size>>(
        mut self,
        min_size: S,
    ) -> Self {
    ...
    #[inline]
    pub fn with_max_inner_size<S: Into<Size>>(
        mut self,
        max_size: S,
    ) -> Self {
    ...
    /// - **Others:** Ignored.
    #[inline]
    pub fn with_position<P: Into<Position>>(
        mut self,
        position: P,
    ) -> Self {
    ...
    #[inline]
    pub fn with_title<T: Into<String>>(
        mut self,
        title: T,
    ) -> Self {
...
impl Window {
    ...
    #[inline]
    pub fn set_outer_position<P: Into<Position>>(
        &self,
        position: P,
    ) {
    ...
    #[inline]
    pub fn set_min_inner_size<S: Into<Size>>(
        &self,
        min_size: Option<S>,
    ) {
    ...
    /// - **iOS / Android / Orbital:** Unsupported.
    #[inline]
    pub fn set_max_inner_size<S: Into<Size>>(
        &self,
        max_size: Option<S>,
    ) {
    ...
    #[inline]
    pub fn set_resize_increments<S: Into<Size>>(
        &self,
        increments: Option<S>,
    ) {
...
impl Window {
    ...
    pub fn set_content_protected(
        ...
        let _span = tracing::debug_span!("winit::Window::set_content_protected", protected).entered();
        self.window
...
impl ActivationToken {
    ...
    #[cfg_attr(not(any(x11_platform, wayland_platform, docsrs)), doc = " `request_activation_token`.")]
