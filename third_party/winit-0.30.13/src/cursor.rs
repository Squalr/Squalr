...
impl CustomCursor {
    ...
    pub fn from_rgba(
        ...
        let _span = tracing::debug_span!("winit::Cursor::from_rgba", width, height, hotspot_x, hotspot_y).entered();

        Ok(CustomCursorSource {
            inner: PlatformCustomCursorSource::from_rgba(rgba.into(), width, height, hotspot_x, hotspot_y)?,
        })
    }
}
