...
use core_foundation::runloop::{
    ...
    CFRunLoopAddTimer, CFRunLoopGetMain, CFRunLoopObserverCallBack, CFRunLoopObserverContext, CFRunLoopObserverCreate, CFRunLoopObserverRef, CFRunLoopRef,
    CFRunLoopTimerCreate, CFRunLoopTimerInvalidate, CFRunLoopTimerRef, CFRunLoopTimerSetNextFireDate, CFRunLoopWakeUp,
};
...
unsafe fn control_flow_handler<F>(
...
pub fn setup_control_flow_observers(
    ...
    unsafe {
        ...
        run_loop.add_observer(kCFRunLoopAfterWaiting, CFIndex::MIN, control_flow_begin_handler, &mut context as *mut _);
