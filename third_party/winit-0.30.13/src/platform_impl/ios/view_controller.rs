...
use objc2_ui_kit::{UIDevice, UIInterfaceOrientationMask, UIRectEdge, UIResponder, UIStatusBarStyle, UIUserInterfaceIdiom, UIView, UIViewController};
...
impl WinitViewController {
    pub(crate) fn set_prefers_status_bar_hidden(
        &self,
        val: bool,
    ) {
    ...
    pub(crate) fn set_preferred_status_bar_style(
        &self,
        val: StatusBarStyle,
    ) {
        let val = match val {
    ...
    pub(crate) fn set_prefers_home_indicator_auto_hidden(
        &self,
        val: bool,
    ) {
    ...
    pub(crate) fn set_supported_interface_orientations(
        ...
        let mask = match (valid_orientations, UIDevice::currentDevice(mtm).userInterfaceIdiom()) {
            (ValidOrientations::LandscapeAndPortrait, UIUserInterfaceIdiom::Phone) => UIInterfaceOrientationMask::AllButUpsideDown,
            (ValidOrientations::LandscapeAndPortrait, _) => UIInterfaceOrientationMask::All,
            (ValidOrientations::Landscape, _) => UIInterfaceOrientationMask::Landscape,
            (ValidOrientations::Portrait, UIUserInterfaceIdiom::Phone) => UIInterfaceOrientationMask::Portrait,
    ...
    pub(crate) fn new(
        ...
        this.set_prefers_status_bar_hidden(window_attributes.platform_specific.prefers_status_bar_hidden);

        this.set_preferred_status_bar_style(window_attributes.platform_specific.preferred_status_bar_style);
