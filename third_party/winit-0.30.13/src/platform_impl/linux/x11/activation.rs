...
impl XConnection {
    ...
    pub(crate) fn request_activation_token(
        ...
        let activation_token = format!("{}{}_TIME{}", uname.nodename().to_str().unwrap_or("winit"), pid.as_raw_nonzero(), time);
    ...
    fn send_message(
        ...
        let window = xproto::WindowWrapper::create_window(
            ...
            &xproto::CreateWindowAux::new()
                .override_redirect(1)
                .event_mask(xproto::EventMask::STRUCTURE_NOTIFY | xproto::EventMask::PROPERTY_CHANGE),
        )?;
        ...
        message
            ...
            .map(|chunk| {
                ...
                let event = xproto::ClientMessageEvent::new(8, window.window(), message_type, buffer);
