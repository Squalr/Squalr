...
impl Dnd {
    ...
    pub unsafe fn get_type_list(
        ...
        let atoms = self.xconn.atoms();
        self.xconn
            .get_property(source_window, atoms[XdndTypeList], xproto::Atom::from(xproto::AtomEnum::ATOM))
    }
    ...
    pub unsafe fn convert_selection(
        ...
        self.xconn
            .xcb_connection()
            .convert_selection(window, atoms[XdndSelection], atoms[TextUriList], atoms[XdndSelection], time)
