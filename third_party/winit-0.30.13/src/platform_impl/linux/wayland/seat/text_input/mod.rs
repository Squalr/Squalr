...
use sctk::reexports::protocols::wp::text_input::zv3::client::zwp_text_input_v3::{ContentHint, ContentPurpose, Event as TextInputEvent, ZwpTextInputV3};
    ...
    fn event(
        ...
        match event {
            ...
            TextInputEvent::Done { .. } => {
                ...
                if text_input_data.pending_commit.is_some() || text_input_data.pending_preedit.is_none() {
                    state
                        .events_sink
                        .push_window_event(WindowEvent::Ime(Ime::Preedit(String::new(), None)), window_id);
                }
                ...
                if let Some(preedit) = text_input_data.pending_preedit.take() {
                    ...
                    state
                        .events_sink
                        .push_window_event(WindowEvent::Ime(Ime::Preedit(preedit.text, cursor_range)), window_id);
                }
            }
...
pub trait ZwpTextInputV3Ext {
    fn set_content_type_by_purpose(
        &self,
        purpose: ImePurpose,
    );
}
