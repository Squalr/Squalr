...
pub trait WindowExtIOS {
    ...
    fn set_prefers_status_bar_hidden(
        &self,
        hidden: bool,
    );
    ...
    /// [`setNeedsStatusBarAppearanceUpdate()`](https://developer.apple.com/documentation/uikit/uiviewcontroller/1621354-setneedsstatusbarappearanceupdat?language=objc)
    /// is also called for you.
    fn set_preferred_status_bar_style(
        &self,
    ...
    ///
    /// The default is to not recognize gestures.
    fn recognize_doubletap_gesture(
        &self,
        should_recognize: bool,
    );
...
impl WindowExtIOS for Window {
    ...
    fn set_preferred_screen_edges_deferring_system_gestures(
        ...
        self.window
            .maybe_queue_on_main(move |w| w.set_preferred_screen_edges_deferring_system_gestures(edges))
    }
    ...
    fn recognize_pan_gesture(
        ...
        self.window
            .maybe_queue_on_main(move |w| w.recognize_pan_gesture(should_recognize, minimum_number_of_touches, maximum_number_of_touches));
    }
...
pub trait WindowAttributesExtIOS {
    ...
    fn with_prefers_status_bar_hidden(
        self,
        hidden: bool,
    ) -> Self;
