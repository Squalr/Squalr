...
impl<T> EventLoopExtWebSys for EventLoop<T> {
    ...
    fn spawn_app<A: ApplicationHandler<Self::UserEvent> + 'static>(
        ...
        self.event_loop
            .spawn(move |event, event_loop| event_loop::dispatch_event_for_app(&mut app, event_loop, event));
    }
...
impl CustomCursorExtWebSys for CustomCursor {
    ...
    fn from_url(
        ...
        CustomCursorSource {
            inner: PlatformCustomCursorSource::Url { url, hotspot_x, hotspot_y },
        }
    }
