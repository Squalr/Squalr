...
use winit::window::{Cursor, CursorGrabMode, CustomCursor, CustomCursorSource, Fullscreen, Icon, ResizeDirection, Theme, Window, WindowId};

#[cfg(macos_platform)]
use winit::platform::macos::{OptionAsAlt, WindowAttributesExtMacOS, WindowExtMacOS};
#[cfg(any(x11_platform, wayland_platform))]
use winit::platform::startup_notify::{self, EventLoopExtStartupNotify, WindowAttributesExtStartupNotify, WindowExtStartupNotify};
#[cfg(x11_platform)]
...
impl Application {
    fn new<T>(event_loop: &EventLoop<T>) -> Self {
        ...
        #[cfg(not(any(android_platform, ios_platform)))]
        let context =
            Some(Context::new(unsafe { std::mem::transmute::<DisplayHandle<'_>, DisplayHandle<'static>>(event_loop.display_handle().unwrap()) }).unwrap());
    ...
    fn create_window(
        ...
        match std::env::var("X11_SCREEN_ID") {
            ...
            Err(_) => info!("Set the X11_SCREEN_ID env variable to place the window on non-default screen"),
        }
    ...
    fn handle_action(
        ...
        match action {
            ...
            #[cfg(web_platform)]
            Action::AnimationCustomCursor => window.animation_custom_cursor(event_loop, &self.custom_cursors),
...
const KEY_BINDINGS: &[Binding<&'static str>] = &[
    ...
    #[cfg(web_platform)]
    Binding::new("C", ModifiersState::CONTROL.union(ModifiersState::SHIFT), Action::UrlCustomCursor),
    #[cfg(web_platform)]
    Binding::new("C", ModifiersState::ALT.union(ModifiersState::SHIFT), Action::AnimationCustomCursor),
