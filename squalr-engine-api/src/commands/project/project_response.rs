...
use crate::commands::project::{close::project_close_response::ProjectCloseResponse, delete::project_delete_response::ProjectDeleteResponse};
use serde::{Deserialize, Serialize};

#[derive(Clone, Debug, Serialize, Deserialize)]
pub enum ProjectResponse {
    Create { project_create_response: ProjectCreateResponse },
    Delete { project_delete_response: ProjectDeleteResponse },
