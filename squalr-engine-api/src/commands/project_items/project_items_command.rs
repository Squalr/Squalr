...
pub enum ProjectItemsCommand {
    ...
    Add { project_items_add_request: ProjectItemsAddRequest },
    /// Activates project items.
    Activate {
        project_items_activate_request: ProjectItemsActivateRequest,
    },
    /// Creates a project item.
    Create { project_items_create_request: ProjectItemsCreateRequest },
    /// Deletes project items.
    Delete { project_items_delete_request: ProjectItemsDeleteRequest },
    ...
    /// Moves project items.
    Move { project_items_move_request: ProjectItemsMoveRequest },
    ...
    Rename { project_items_rename_request: ProjectItemsRenameRequest },
