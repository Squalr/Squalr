...
impl DataType for DataTypeU8 {
    ...
    fn anonymize_value_bytes(
        ...
        let anonymous_value_string = PrimitiveDataTypeNumeric::anonymize(value_bytes, |value_bytes| value_bytes[0], anonymous_value_string_format)?;
