...
impl DataTypeI16 {
    pub const DATA_TYPE_ID: &str = "i16";
...
impl DataType for DataTypeI16 {
    ...
    fn create_data_value_interpreters(
        ...
        PrimitiveDataType::create_data_value_interpreters(value_bytes, |value_bytes| PrimitiveType::from_le_bytes([value_bytes[0], value_bytes[1]]))
    }
