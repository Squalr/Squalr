use crate::structures::{data_types::data_type_error::DataTypeError, data_values::anonymous_value::AnonymousValue};
...
impl PrimitiveDataType {
    ...
    {
        let is_value_hex = anonymous_value.is_value_hex;
        let value_string = &anonymous_value.value_str;
