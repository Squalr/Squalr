...
impl DataTypeI32 {
    pub const DATA_TYPE_ID: &str = "i32";
...
impl DataType for DataTypeI32 {
    ...
    fn create_display_value(
        ...
        if actual == expected {
            Ok(PrimitiveType::from_le_bytes([value_bytes[0], value_bytes[1], value_bytes[2], value_bytes[3]]).to_string())
        } else {
    ...
    fn get_default_value(
        ...
        DataValue::new(data_type_ref.clone(), Self::to_vec(0))
    }
