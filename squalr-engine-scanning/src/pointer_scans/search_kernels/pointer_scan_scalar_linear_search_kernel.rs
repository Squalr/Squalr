...
pub(crate) struct ScalarLinearPointerScanKernel<'a> {
    target_range_set: &'a PointerScanTargetRangeSet,
    pointer_size: PointerScanPointerSize,
}

impl<'a> ScalarLinearPointerScanKernel<'a> {
    pub(crate) fn new(
        target_range_set: &'a PointerScanTargetRangeSet,
        pointer_size: PointerScanPointerSize,
    ) -> Self {
...
impl PointerScanSearchKernel for ScalarLinearPointerScanKernel<'_> {
