use crate::{filters::snapshot_region_filter::SnapshotRegionFilter, scanners::constraints::scan_constraint::ScanConstraint};
...
impl SnapshotFilter {
    ...
    pub fn get_snapshot_region_filters(&self) -> &Vec<SnapshotRegionFilter> {
        return &self.region_filters;
    }
    ...
    pub fn get_region_count(&self) -> u64 {
        return self.region_filters.len() as u64;
    }
