...
use crate::scanners::encoders::scalar::scanner_scalar_encoder_byte_array_overlapping::ScannerScalarEncoderByteArrayOverlapping;
...
pub struct ScannerScalarIterativeByteArrayOverlapping {}

impl ScannerScalarIterativeByteArrayOverlapping {}
...
impl Scanner for ScannerScalarIterativeByteArrayOverlapping {
    ...
    fn scan_region(
        ...
        let results = ScannerScalarEncoderByteArrayOverlapping::scalar_encode_byte_array(
