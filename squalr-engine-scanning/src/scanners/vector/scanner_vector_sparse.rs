    ...
    LaneCount<N>: SupportedLaneCount + VectorComparer<N>,
{
    ...
    fn scan_region(
        ...
        let remainder_ptr_offset = vectorizable_iterations as usize * vector_size_in_bytes;
            ...
            match vector_compare_func {
                ScanFunctionVector::Immediate(compare_func) => {
                    ...
                    for index in 0..vectorizable_iterations {
                        let current_values_pointer = unsafe { current_values_pointer.add(index as usize * vector_size_in_bytes) };
