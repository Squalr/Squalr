use crate::{
    ...
    views::{
        code_viewer::view_data::code_viewer_view_data::CodeViewerViewData, process_selector::view_data::process_selector_view_data::ProcessSelectorViewData,
    },
};
use eframe::egui::{
