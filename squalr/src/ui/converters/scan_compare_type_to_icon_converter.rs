...
impl ScanCompareTypeToIconConverter {
    pub fn convert_scan_compare_type_immediate_to_icon(
    ...
    pub fn convert_scan_compare_type_delta_to_icon(
    ...
    pub fn convert_scan_compare_type_relative_to_icon(
        scan_compare_type_relative: &ScanCompareTypeRelative,
        icon_library: &IconLibrary,
    ) -> TextureHandle {
    ...
    pub fn convert_scan_compare_type_to_icon(
        ...
        match scan_compare_type {
            ScanCompareType::Delta(scan_compare_type_delta) => Self::convert_scan_compare_type_delta_to_icon(scan_compare_type_delta, icon_library),
            ScanCompareType::Immediate(scan_compare_type_immediate) => {
                Self::convert_scan_compare_type_immediate_to_icon(scan_compare_type_immediate, icon_library)
            }
            ScanCompareType::Relative(scan_compare_type_relative) => Self::convert_scan_compare_type_relative_to_icon(scan_compare_type_relative, icon_library),
        }
    }
}
