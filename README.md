...
| Text command shell | A CLI, REPL, remote shell, or script bridge that wants Squalr command text lowered into engine commands. | Console grammar, aliases, help/version handling, and conversion into shared command models. | `squalr-engine-api` |
