...
impl DataTypeU64beVector {
    ...
    {
        |current_values_ptr: *const u8, immediate_value_ptr: *const u8| unsafe {
            let current_values = Simd::cast::<PrimitiveType>(Simd::swap_bytes(Simd::from_array(ptr::read_unaligned(
                current_values_ptr as *const [PrimitiveTypeSigned; N],
            ))));
            let immediate_value = Simd::cast::<PrimitiveType>(Simd::swap_bytes(Simd::splat(ptr::read_unaligned(
                immediate_value_ptr as *const PrimitiveTypeSigned,
            ))));
        ...
        LaneCount<N>: SupportedLaneCount,
    {
        |current_values_ptr: *const u8, previous_values_ptr: *const u8| unsafe {
            ...
            let previous_values = Simd::cast::<PrimitiveType>(Simd::swap_bytes(Simd::splat(ptr::read_unaligned(
                previous_values_ptr as *const PrimitiveTypeSigned,
            ))));
        ...
        LaneCount<N>: SupportedLaneCount,
    {
        |current_values_ptr: *const u8, previous_values_ptr: *const u8, delta_ptr: *const u8| unsafe {
            ...
            let delta_value = Simd::cast::<PrimitiveType>(Simd::swap_bytes(Simd::splat(ptr::read_unaligned(delta_ptr as *const PrimitiveTypeSigned))));
...
impl VectorComparable for DataTypeU64be {
    fn get_vector_compare_equal_64(&self) -> VectorCompareFnImmediate64 {
        DataTypeU64beVector::get_vector_compare_equal()
    }
    ...
    fn get_vector_compare_not_equal_64(&self) -> VectorCompareFnImmediate64 {
        DataTypeU64beVector::get_vector_compare_not_equal()
    }
    ...
    fn get_vector_compare_greater_than_64(&self) -> VectorCompareFnImmediate64 {
        DataTypeU64beVector::get_vector_compare_greater_than()
    }
    ...
    fn get_vector_compare_greater_than_or_equal_64(&self) -> VectorCompareFnImmediate64 {
        DataTypeU64beVector::get_vector_compare_greater_than_or_equal()
    }
    ...
    fn get_vector_compare_less_than_64(&self) -> VectorCompareFnImmediate64 {
        DataTypeU64beVector::get_vector_compare_less_than()
    }
    ...
    fn get_vector_compare_less_than_or_equal_64(&self) -> VectorCompareFnImmediate64 {
        DataTypeU64beVector::get_vector_compare_less_than_or_equal()
    }
    ...
    fn get_vector_compare_changed_64(&self) -> VectorCompareFnRelative64 {
        DataTypeU64beVector::get_vector_compare_changed()
    }
    ...
    fn get_vector_compare_unchanged_64(&self) -> VectorCompareFnRelative64 {
        DataTypeU64beVector::get_vector_compare_unchanged()
    }
    ...
    fn get_vector_compare_increased_64(&self) -> VectorCompareFnRelative64 {
        DataTypeU64beVector::get_vector_compare_increased()
    }
    ...
    fn get_vector_compare_decreased_64(&self) -> VectorCompareFnRelative64 {
        DataTypeU64beVector::get_vector_compare_decreased()
    }
    ...
    fn get_vector_compare_increased_by_64(&self) -> VectorCompareFnDelta64 {
        DataTypeU64beVector::get_vector_compare_increased_by()
    }
    ...
    fn get_vector_compare_decreased_by_64(&self) -> VectorCompareFnDelta64 {
        DataTypeU64beVector::get_vector_compare_decreased_by()
    }
