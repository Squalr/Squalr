...
namespace Microsoft.Diagnostics.Runtime.Interop
{
    ...
    public interface IDebugControl3 : IDebugControl2
    {
        ...
        [PreserveSig]
        new Int32 GetNumberBreakpoInt32s(
            [Out] out UInt32 Number);

        [PreserveSig]
        new Int32 GetBreakpoInt32ByIndex(
            [In] UInt32 Index,
            [Out, MarshalAs(UnmanagedType.Interface)] out IDebugBreakpoint bp);

        [PreserveSig]
        new Int32 GetBreakpoInt32ById(
            [In] UInt32 Id,
            [Out, MarshalAs(UnmanagedType.Interface)] out IDebugBreakpoint bp);

        [PreserveSig]
        new Int32 GetBreakpoInt32Parameters(
            [In] UInt32 Count,
        ...
        [PreserveSig]
        new Int32 AddBreakpoInt32(
            [In] DEBUG_BREAKPOINT_TYPE Type,
            [In] UInt32 DesiredId,
            [Out, MarshalAs(UnmanagedType.Interface)] out IDebugBreakpoint Bp);

        [PreserveSig]
        new Int32 RemoveBreakpoInt32(
        ...
        [PreserveSig]
        Int32 GetAssemblyOptions(
            [Out] out DEBUG_ASMOPT Options);

        [PreserveSig]
        Int32 AddAssemblyOptions(
            [In] DEBUG_ASMOPT Options);

        [PreserveSig]
        Int32 RemoveAssemblyOptions(
            [In] DEBUG_ASMOPT Options);

        [PreserveSig]
        Int32 SetAssemblyOptions(
            [In] DEBUG_ASMOPT Options);

        [PreserveSig]
        Int32 GetExpressionSyntax(
            [Out] out DEBUG_EXPR Flags);

        [PreserveSig]
        Int32 SetExpressionSyntax(
            [In] DEBUG_EXPR Flags);

        [PreserveSig]
        Int32 SetExpressionSyntaxByName(
            [In, MarshalAs(UnmanagedType.LPStr)] String AbbrevName);

        [PreserveSig]
        Int32 GetNumberExpressionSyntaxes(
            [Out] out UInt32 Number);

        [PreserveSig]
        Int32 GetExpressionSyntaxNames(
            [In] UInt32 Index,
            [Out, MarshalAs(UnmanagedType.LPStr)] StringBuilder FullNameBuffer,
            [In] Int32 FullNameBufferSize,
            [Out] out UInt32 FullNameSize,
        ...
        [PreserveSig]
        Int32 GetNumberEvents(
            [Out] out UInt32 Events);

        [PreserveSig]
        Int32 GetEventIndexDescription(
            [In] UInt32 Index,
        ...
        [PreserveSig]
        Int32 GetCurrentEventIndex(
            [Out] out UInt32 Index);

        [PreserveSig]
        Int32 SetNextEventIndex(
