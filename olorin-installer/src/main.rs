...
// Model: The various olorin-engine projects that handle the system/app functionality.
// ViewModel: This olorin project, containing the glue that binds the .slint and engine functionality together.
pub fn main() {
    ...
    match slint::run_event_loop() {
        Ok(_) => {}
        Err(error) => {
            log::error!("Fatal error starting Olorin Installer GUI: {}", error);
        }
    }
}
