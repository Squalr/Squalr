use crate::{
    comparison_stubs::impl_data_type_comparison_stubs,
    data_types::x86_family_instruction_value::{x86_family_anonymize_instruction_bytes, x86_family_deanonymize_instruction_value},
};
...
#[derive(Clone, Debug)]
pub struct DataTypeInstructionX86 {
    instruction_set: Arc<dyn InstructionSet>,
}

impl DataTypeInstructionX86 {
    pub const DATA_TYPE_ID: &str = "i_x86";

    pub fn new() -> Self {
        Self {
            instruction_set: Arc::new(crate::instruction_set::X86InstructionSet::new()),
        }
    }
}

impl Default for DataTypeInstructionX86 {
    fn default() -> Self {
        Self::new()
    }
}

impl DataType for DataTypeInstructionX86 {
    ...
    fn deanonymize_value_string(
        ...
        x86_family_deanonymize_instruction_value(Self::DATA_TYPE_ID, self.instruction_set.as_ref(), anonymous_value_string)
    }
    ...
    fn anonymize_value_bytes(
        ...
        x86_family_anonymize_instruction_bytes(self.instruction_set.as_ref(), Self::DATA_TYPE_ID, value_bytes, anonymous_value_string_format)
    }
...
impl_data_type_comparison_stubs!(DataTypeInstructionX86);
