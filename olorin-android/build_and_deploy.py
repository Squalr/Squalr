...
os.chdir(parent_dir)
run_command(f"cargo ndk --target aarch64-linux-android build --bin olorin-cli {release_flag} -v")
...
apk_path = os.path.join(parent_dir, "target", "release" if release_flag else "debug", "apk", "olorin-android.apk")
